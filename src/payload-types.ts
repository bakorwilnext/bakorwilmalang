...
export interface Page {
  ...
  hero: {
    ...
    /**
     * Select images to display in the carousel below the hero section
     */
...
export interface ArchiveBlock {
  ...
  limit?: number | null;
  /**
   * Maximum number of posts to display (0 = no limit)
   */
  ...
  selectedDocs?:
    ...
    | null;
  /**
   * Display category filter buttons on the frontend
   */
  ...
  fields?:
    | (
        ...
        | {
            ...
            width?: number | null;
            /**
             * Comma-separated list of accepted file extensions (e.g., .pdf)
             */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AnalyticsBlock".
 */
export interface AnalyticsBlock {
  title?: string | null;
  /**
   * Optional content to display above the analytics
   */
  introContent?: {
    root: {
      type: string;
  ...
  /**
   * Choose what type of analytics to display
   */
  analyticsType?: 'internships' | null;
  /**
...
export interface Internship {
  ...
  /**
   * Rate intern performance from 1-5 (only for completed internships)
   */
  rating?: number | null;
  /**
   * Upload completion certificate (only for completed internships)
   */
  completionCertificate?: (string | null) | Media;
  updatedAt: string;
  createdAt: string;
}
/**
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AnalyticsBlock_select".
 */
export interface AnalyticsBlockSelect<T extends boolean = true> {
  title?: T;
  introContent?: T;
  analyticsType?: T;
  showCharts?: T;
...
export interface Header {
  ...
  navItems?:
    | {
        ...
        /**
         * Enable dropdown menu for this navigation item
         */
        hasDropdown?: boolean | null;
        /**
         * Add items to show in the dropdown menu
         */
        dropdownItems?:
          | {
              link: {
